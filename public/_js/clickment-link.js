...
function link_opensea() {
  window.open("about:blank").location.href =
    "https://opensea.io/collection/klayweathergirls";
}
function link_twitter() {}
function link_discord() {
  window.open("about:blank").location.href =
    "https://discord.com/invite/pczWPcS85h";
}
function link_kakaotalk() {
  window.open("about:blank").location.href =
    "https://open.kakao.com/o/gwsoE5Zd";
}
function link_youtube() {
  window.open("about:blank").location.href =
    "https://www.youtube.com/channel/UCU7jA5XDiijAZgYIuOYonQw";
}
function link_instagram() {
  window.open("about:blank").location.href =
    "https://www.instagram.com/weathergirlsnft";
}
function link_medium() {
  window.open("about:blank").location.href =
    "https://medium.com/@KlayWeatherGirls";
}
...
document
  .getElementsByClassName("roadmap_doodle")[3]
...
function copymailaddress() {
  ...
  setTimeout(function () {
    completed_box.style.animation = "animation-completed-down 0.2s linear";
  }, 3000);
  setTimeout(function () {
