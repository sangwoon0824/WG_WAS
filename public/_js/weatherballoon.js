...
document.querySelectorAll(".balloon").forEach(item=>{item.src = "_img/about/balloon/balloon_" + weather[Math.floor(Math.random() * 5)] + ".png";});
console.log("_img/about/balloon/balloon_" + weather[Math.floor(Math.random() * 5)] + ".png");
